            ...
            <div class="col-md-12">
               <div class="login-box card box-shadow-e" style="border-radius: 5px;">
                   ...
                   <div class="card-body">
                     ...
                     <form class="form-horizontal form-material m-t-20" id="loginform" action="{{ route('admin.login') }}" method="POST">
                        @csrf
                        <h3 class="box-title m-b-20">Admin Sign In</h3>
                        <div class="form-group ">
                            <div class="col-md-12">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required placeholder="Username">
                         ...
                         <div class="form-group row">
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <a href="{{ route('admin.password.request') }}" id="to-recover" class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Forgot Password?</a>
                                    @endif
                                </div>
                            </div>
                        </div>
