...
@section('admincontents')
     ...
     <div class="row">
              ...
              <center class="m-t-30">
               ...
               <div class="card br-b-l-5 m-b-0 p-5 box-shadow-e" style="background: #00000061;color: white;">
                  <div class="row text-center ">
                     ...
                     <div class="col-md-7">
                        <div>
                           <h5 class="font-Trirong font-14 font-w-900">Unit <br><small style="font-size: 100%">{{($posts->unit_name != null) ? $posts->unit_name : 'Not provided'}}</small></h5>
                        </div>
                     </div>
                  </div>
               </div>
          ...
          <div class="tab-content box-shadow br-5 bg-white m-t-10">
            ...
            <div class="tab-pane active show" id="Profiles" role="tabpanel">
              <div class="card br-5 m-b-10 bg-white ">
                <ul class="nav nav-tabs profile-tab" role="tablist">
                  <li class="nav-item"> <a class="nav-link active show bg-white br-5 font-w-700" data-toggle="tab" href="#Personal" role="tab" aria-selected="true">Personal Details</a> </li>
                  <li class="nav-item"><a class="nav-link bg-white br-5 font-w-700" data-toggle="tab" href="#Company" role="tab"  aria-selected="false">Professional Info.</a></li>
                  @if($posts->member_type == 'Member')
                  @if($type == 'Womens Wing')
                  @if($posts->hfid == 'HFWW01')

                  <li class="nav-item"><a class="nav-link bg-white br-5 font-w-700" href="{{route('performanceIndicator',[encrypt($posts->id),encrypt($type),encrypt($unit),encrypt($page)])}}" aria-selected="false">Performance Indicators</a></li>
                  @endif
                  @endif
                  @else
                  <li class="nav-item"><a class="nav-link bg-white br-5 font-w-700" href="{{route('staffAssessments',[encrypt($posts->id),encrypt($type),encrypt($unit),encrypt($page)])}}" aria-selected="false">Staff Assessments</a></li>
                  @endif
                </ul>
              </div>
                ...
                <div class="tab-pane" id="Company" role="tabpanel">
                  <div class="card  p-0-0-10-30">
                    <div class="card-body">
                      ...
                      @if(ifAnd($posts->other_organisation) == true)
                      <?php $since = explode(',', $posts->member_since);$pos = explode(',', $posts->position_held);$i=0;?>
                      <div class="row memberProfileRow familyProfileRow">
                        <div class="col-md-12">
                          <hr>
                          <h4>Other Organizations Info.</h4>
                        </div>
                        @foreach(explode(',',$posts->other_organisation) as $Org)
                        <div class="col-md-6">
                          <div class="media">
                            <div class="media-left">
                              <small class="p-t-30 font-Trirong"><i class="ti-plus"></i> <b> Company Name :</b></small>
                            </div>
                            <div class="media-body">
                              <p>{{$Org}} </p>
                            </div>
                        ...
                        <div class="col-md-3">
                          <div class="media">
                            <div class="media-left">
                              <small class="p-t-30 font-Trirong"><b> Member Since :</b></small>
                            </div>
                            <div class="media-body">
                              <p>{{$since[$i]}} </p>
                            </div>
                        ...
                        <div class="col-md-3">
                          <div class="media">
                            <div class="media-left">
                              <small class="p-t-30 font-Trirong"><b> Position Held :</b></small>
                            </div>
                            <div class="media-body">
                              <p>{{$pos[$i]}} </p>
                            </div>
      ...
      <!-- <a href="javascript:void" class="btn btn-circle btn-outline-primary fixedbutton"></a> -->
