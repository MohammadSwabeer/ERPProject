      ...
      <div class="col-md-12">
        <div class="d-flex">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{route('getMemberProfile',[encrypt($id),encrypt($type),encrypt($unit),encrypt($page)])}}">{{$type}} {{$main->find_field_data('unit_details','unit_name',$unit)[0]->unit_name}} </a></li>
              <li class="breadcrumb-item"><a href="{{route('performanceIndicator',[encrypt($id),encrypt($type),encrypt($unit),encrypt($page)])}}">Perfomance Indicators</a></li>
              <li class="breadcrumb-item active">Report</li>
            </ol>
         </div>
         <div style="margin-top: -37px">
           <a class="btn btn-default btn-outline pull-right" href="{{route('printReport',[encrypt($id),encrypt($type),encrypt($unit),encrypt($page)])}}"><i class="fa fa-print"></i> &nbsp;  Print</a>
         </div>
      </div>
   </div>
